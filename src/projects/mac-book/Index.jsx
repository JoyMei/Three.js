...
function Composition({ ...props }) {
  ...
  const [textureRed, textureBlue] = useTexture([require('./model/Chroma Red.jpg') ,require('./model/Chroma Blue.jpg')])
...
const M1 = forwardRef(({ texture, children, ...props }, ref) => {
  const { nodes, materials } = useGLTF(require('./model/mbp-v1-pipe.glb'))
  return (
    <group {...props} dispose={null}>
      <group ref={ref} position={[0, -0.43, -11.35]} rotation={[Math.PI / 2, 0, 0]}>
        ...
        <mesh geometry={nodes.matte.geometry}>
          <meshLambertMaterial map={texture} toneMProject2ed={false} />
        </mesh>
      </group>
      {children}
